...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    Logger.app('🔄 App lifecycle state changed: $state');

    // Update app state for notification service
    switch (state) {
      case AppLifecycleState.resumed:
        Logger.app('📱 App resumed - setting to foreground');
      ...
      case AppLifecycleState.paused:
        Logger.app('📱 App paused - setting to background');
        AppNotificationService.setAppState(false);
        break;
      case AppLifecycleState.detached:
        Logger.app('📱 App detached - setting to background');
        AppNotificationService.setAppState(false);
        break;
      case AppLifecycleState.hidden:
        Logger.app('📱 App hidden - setting to background');
        AppNotificationService.setAppState(false);
        break;
    }
  }
